...
| Repudiation            | A production build cannot be tied to reviewed source                                         | immutable lockfile, CI artefacts, recorded Workers version and commit record                                                  | provenance/signing depends on repository and platform settings                                                    |
